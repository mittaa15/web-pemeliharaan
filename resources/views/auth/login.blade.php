...
<body class="bg-primary flex items-center justify-center h-screen px-4">

    <div class="bg-white rounded-lg shadow-xl px-6 py-6 w-full max-w-sm sm:max-w-md">
        <!-- Flash Messages -->
        @if(session('success'))
        <div id="success-alert" class="bg-green-100 text-green-800 flex justify-center p-2 mb-4 rounded text-sm">
            {{ session('success') }}
        </div>
        @endif

        @if($errors->has('message'))
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative my-2 text-sm">
        ...
        <div class="text-center mb-6">
            <h2 class="text-2xl font-bold font-sans judul-pemeliharaan">
        ...
        <form action="{{ route('login') }}" method="POST" class="w-full">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email"
                    class="bg-white border border-gray-300 rounded-lg w-full p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-600"
                    required>
            </div>
            ...
            <div class="mb-4 relative">
                ...
                <input type="password" name="password" id="password"
                    class="bg-white border border-gray-300 rounded-lg w-full p-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-600"
                    required>
        ...
        <div class="mt-4 text-center">
            <a href="/register" class="block text-sm mb-1 text-blue-500 hover:underline">Daftar</a>
