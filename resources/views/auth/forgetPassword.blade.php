...
<body class="bg-primary flex items-center justify-center h-screen">
    ...
    <div class="bg-white rounded-lg shadow-xl px-10 py-7">
        ...
        <form class="w-96" method="POST" action="{{ url('/forgot-password') }}">
            @csrf
            <div class="mb-4">
            ...
            <button type="submit"
                class="w-full bg-[#4aff25] text-white font-semibold text-base py-2 rounded-lg hover:bg-green-500 transition">Send
