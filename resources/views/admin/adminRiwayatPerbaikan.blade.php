    ...
    function showDetail(reportId) {
        ...
        <tr>
            ...
            <td class="px-6 py-3">
                ...
                <tr>
        <td class="px-6 py-3 font-semibold">Nama Teknisi</td>
        <td class="px-6 py-3">
            ${
            laporan.repair_technicians?.length
                ? laporan.repair_technicians.map(rt => rt.technician?.name).filter(Boolean).join(', ')
                : '-'
            }
        </td>
        </tr>
