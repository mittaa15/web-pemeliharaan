...
<div class="p-8">
    <div class="bg-white rounded-md w-full py-10 px-10">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div>
                <input id="search" type="text" placeholder="Cari ruangan..."
    ...
    <div class="bg-white p-6 rounded-lg w-1/2">
        ...
        <form id="addRoomForm" action="{{ route('create_room') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" class="input input-bordered w-full bg-white text-gray-600 border-gray-300"
                    required></textarea>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium mb-1 text-primary">Gedung</label>
                <select name="id_building" class="input input-bordered w-full bg-white text-gray-600 border-gray-300"
                    required>
