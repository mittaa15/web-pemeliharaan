...
<div class="p-8">
    <div class="bg-white rounded-md w-full py-10 px-10">
        ...
        <!-- Bagian show entries dan search -->
        ...
        <div class="overflow-x-auto w-full">
            <table id="keluhanTable" class="min-w-[700px] table w-full text-sm text-left text-gray-600">
...
<div id="detailModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg w-[90%] max-w-md p-6 shadow-lg relative">
