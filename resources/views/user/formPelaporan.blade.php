    ...
    <div class="bg-white rounded-md w-full py-10 px-10">
        ...
        <form id="formPelaporan" method="POST" action="{{ route('create-laporan') }}" enctype="multipart/form-data">
                    ...
                    <div id="wrapperFasilitas" class="col-span-1">
                        ...
                        <div class="py-2">
                            <label class="block text-gray-400 mb-2">Fasilitas<span class="text-red-600">
                                    *</span></label>
                            <select name="id_facility_room" id="fasilitas" required
                                class="input block w-full bg-white input-bordered border-gray-300 text-gray-600">
            ...
            <div class="flex justify-center mt-4 gap-3">
                <button type="submit" id="btnSimpan" class="btn w-1/6 bg-primary border-none text-white">Simpan</button>
            </div>
        </form>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    modalTambahLagi?.addEventListener('click', function() {
        modalTambahLagi.classList.add('hidden');
    });
