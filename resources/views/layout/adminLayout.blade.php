...
<head>
    ...
    <script>
    const updateStatusUrl = "{{ route('update-status-admin') }}";
    ...
    <div class="flex min-h-screen min-w-0">
        ...
        <aside id="sidebar"
            ...
            <nav class="space-y-4 mt-4">
                ...
                <!-- Riwayat Perbaikan -->
                <a href="/admin-riwayat-perbaikan" class="flex items-center gap-2 px-3 py-2 mb-4 rounded hover:bg-blue-50 transition
