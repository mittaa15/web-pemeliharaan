        ...
        <form id="editProfileForm">
            <div class="mb-3">
                ...
                <input type="text" class="w-full p-2 border border-gray-300 rounded bg-white text-gray-700"
                    id="fullName" value="Miftahul Jannah Zahratunnisa" required>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label text-primary">Email</label>
                <input type="email"
                    class="w-full p-2 border border-gray-300 rounded bg-gray-200 text-gray-700 cursor-not-allowed"
                    id="email" value="miftahul.jannah@example.com" readonly>
            </div>
            <div class="mb-3">
