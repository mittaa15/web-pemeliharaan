    ...
    <div class="flex min-h-screen bg-white">
        ...
        <aside class="w-64 bg-base-200 text-base-content p-6 bg-white"
            ...
            <nav class="space-y-4 mt-4">
                <a href="/ajukan-laporan-perbaikan"
                    class="flex items-center text-gray-600 space-x-2 hover:text-blue-700">
                    <span><img src="{{ asset('images/Vector.png') }}"></span><span>Buat Laporan</span>
                </a>
                ...
                <a href="/riwayat-laporan-perbaikan"
                    class="flex items-center text-gray-600 space-x-2 hover:text-blue-700">
                    <span><img src="{{ asset('images/Vector.png') }}"></span><span>Riwayat Perbaikan</span>
                </a>

                <div class="mt-6 text-sm text-gray-500 font-bold">ACCOUNT PAGES</div>
                <a href="/profile" class="flex items-center space-x-2 text-gray-500">
