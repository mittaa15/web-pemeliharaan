<!-- Jangan pakai relative di sini -->
<div class="sticky top-0 z-40 w-full flex justify-end items-center bg-white px-6 py-2 shadow">
    <div class="flex items-center gap-4 py-4">
        ...
        <div class="relative">
            ...
            <!-- POPUP AKAN POSISI RELATIF KE SINI -->
