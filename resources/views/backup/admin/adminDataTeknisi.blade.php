...
<div class="p-8">
    ...
    <div class="bg-white rounded-md w-full py-10 px-10">
        <h1 class="text-primary font-bold text-xl mb-4">Daftar Teknisi</h1>
                ...
                <tr class="technician-row" data-id="{{ $technician->id }}" data-name="{{ $technician->name }}"
                    ...
                    <td class="px-6 py-3">
                        <div class="relative inline-block text-left">
                            <button onclick="toggleDropdown(this)" class="text-primary hover:underline">Aksi ▼</button>
                            <div
...
<div id="addTechnicianModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
...
<!-- Modal Edit Teknisi -->
<div id="editTechnicianModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-6 rounded-lg w-1/2">
...
<div id="confirmDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-6 rounded-lg w-1/3">
        ...
        <p class="text-gray-700 mb-6 text-sm">Apakah Anda yakin ingin menghapus <span id="technicianToDeleteName"
